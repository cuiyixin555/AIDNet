...
parser = argparse.ArgumentParser(description="AID_Test")
parser.add_argument("--logdir", type=str, default='./logs/RainLight/AID_location135/', help='path of log files')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/SoftWare1/DerainDataset/SPA/real_test_1000/rain/', help='path to testing data')
parser.add_argument("--save_path", type=str, default='./results/', help='path to save results')
parser.add_argument('--save_path_r', type=str, default='./results/rainstreak/', help='path to save rain streaks')
...
def main():
    ...
    if opt.use_GPU:
        model = model.cuda()
    state_dict = torch.load(os.path.join(opt.logdir, 'net_epoch15.pth'))
    ...
    for img_name in os.listdir(opt.data_path):
        if is_image(img_name):
            ...
            cv2.imwrite(os.path.join(save_path_r, rain_name), save_rain)
